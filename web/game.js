...
const planetData = {
    planets: [
        { "name": "stay-test-dont-remove-it", "pl_percentage": 0.00, "color": "darkgrey", "moons": [] },
        { "name": "TRAPPIST-1b", "pl_percentage": 0.00, "color": "darkgrey", "moons": [] },
        { "name": "TRAPPIST-1c", "pl_percentage": 36.18, "color": "darkkhaki", "moons": [] },
        { "name": "TRAPPIST-1d", "pl_percentage": 56.29, "color": "dodgerblue", "moons": [{ "name": "MOON", "distance": 11, "size": 0.85, "color": "lightgrey" }] },
        { "name": "TRAPPIST-1e", "pl_percentage": 57.75, "color": "darkorange", "moons": [{ "name": "DEIMOS", "distance": 8, "size": 0.4, "color": "grey" }, { "name": "PHOBOS", "distance": 10, "size": 0.8, "color": "darkgrey" }] },
        { "name": "TRAPPIST-1f", "pl_percentage": 57.98, "color": "darksalmon", "moons": [{ "name": "EUROPA", "distance": 20, "size": 0.8, "color": "cadetblue" }, { "name": "IO", "distance": 17.5, "size": 0.5, "color": "gold" }, { "name": "GANYMEDE", "distance": 22.5, "size": 0.65, "color": "purple" }, { "name": "CALLISTO", "distance": 24.45, "size": 0.725, "color": "grey" }] },
        { "name": "TRAPPIST-1g", "pl_percentage": 44.24, "color": "burlywood", "moons": [{ "name": "TITAN", "distance": 12.5, "size": 0.725, "color": "darkcyan" }, { "name": "ENCELADUS", "distance": 14.95, "size": 0.45, "color": "white" }] },
        { "name": "TRAPPIST-1h", "pl_percentage": 35.99, "color": "lightblue", "moons": [] }
    ]
}; 
...
var year = 2024, population, growthRate = 0.05;
...
function init() {
    ...
    // Add planets in the desired order
    planets.add(30, 2, "TRAPPIST-1b", 0.5, "darkgrey", 0); // TRAPPIST-1b
    planets.add(50, 2, "TRAPPIST-1c", 0.2, "darkkhaki", 0); // TRAPPIST-1c
    planets.add(70, 2, "TRAPPIST-1d", 0.9, "dodgerblue", 100000); // TRAPPIST-1d
    // planets.planetsList[2].addMoon(11, 0.85, "MOON", 2, "lightgrey", 0);
    planets.add(210, 3, "TRAPPIST-1e", 0.3, "darkorange", 0); // TRAPPIST-1e
    // planets.planetsList[3].addMoon(8, 0.4, "DEIMOS", 0.9, "grey", 0);
    // planets.planetsList[3].addMoon(10, 0.8, "PHOBOS", 1.8, "darkgrey", 0);
    planets.add(295, 10, "TRAPPIST-1f", 0.1, "darksalmon", 0); // TRAPPIST-1f
    ...
    planets.add(340, 8, "TRAPPIST-1g", 0.078, "burlywood", 0); // TRAPPIST-1g
    ...
    planets.add(380, 6, "TRAPPIST-1h", 0.058, "lightblue", 0); // TRAPPIST-1h
...
hud = {
    displayPopulation: function() {
        ...
        o.fillStyle = "white";
        o.font = "14px Arial";
        o.fillText("E   X   O   A   T   L   A   S", overlay.width / 2, overlay.height / 2 - 7);
        o.font = "24px Arial";
...
displayPlanetStats: function() {
    ...
    if (current !== null && current.index !== undefined && planetData.planets[current.index]) {
        const planet = planetData.planets[current.index];

        o2.fillStyle = planet.color;
        o2.fillText(planet.name, 30, 100);
        o2.globalAlpha = 0.45;
        o2.fillStyle = "white";
        o2.font = "15px Arial";

        o2.fillText("Habitability Percentage: " + planet.pl_percentage.toFixed(2), 30, 130);
        o2.fillText("Moons: " + (planet.moons.length > 0 ? planet.moons.map(moon => moon.name).join(", ") : "None"), 30, 150);
    } else {
        o2.fillStyle = "grey";
...
sun = {
    ...
    render: function() {
        ...
        g.addColorStop(0, "#ff2727");
        g.addColorStop(0.1, "#ff2323b8");
        g.addColorStop(0.35, "#ff73733b");
